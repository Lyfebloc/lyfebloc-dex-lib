...
import (
	...
	graphqlPkg "github.com/Lyfebloc/lyfebloc-dex-lib/pkg/util/graphql"
)
...
func (d *PoolTracker) GetNewPoolState(ctx context.Context, p entity.Pool) (entity.Pool, error) {
	logger.Infof("[Automatic] Start getting new state of pool: %v", p.Address)
	...
	logger.Infof("[Automatic] Finish getting new state of pool: %v", p.Address)
